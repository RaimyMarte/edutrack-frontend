...
const TRANSLATIONS: Translations = {
  ...
  updateGradesFor: { en: 'Gradebook & Evaluations:', es: 'Libro de Calificaciones & Evaluaciones:' },
  updateGradesSub: { en: 'Manage midterms, project evaluations, and final grades per student', es: 'Administra exámenes parciales, proyectos y la nota final por estudiante' },
  editGrades: { en: 'Edit Grades', es: 'Editar Calificaciones' },
  saveGrades: { en: 'Save Grades', es: 'Guardar Calificaciones' },
  student: { en: 'Student', es: 'Estudiante' },
  grade: { en: 'Final Grade', es: 'Nota Final' },
  letterGrade: { en: 'Letter', es: 'Literal' },
  exam1: { en: '1st Midterm (30%)', es: '1er Parcial (30%)' },
  exam2: { en: '2nd Midterm (30%)', es: '2do Parcial (30%)' },
  projectTasks: { en: 'Project & Labs (20%)', es: 'Proyecto & Prácticas (20%)' },
  finalExam: { en: 'Final Exam (20%)', es: 'Examen Final (20%)' },
  passed: { en: 'Passed', es: 'Aprobado' },
  failed: { en: 'Failed', es: 'Reprobado' },
  autoCalculateInfo: { en: 'Weighted formula: (1st Midterm × 30%) + (2nd Midterm × 30%) + (Project × 20%) + (Final Exam × 20%)', es: 'Fórmula ponderada: (1er Parcial × 30%) + (2do Parcial × 30%) + (Proyecto × 20%) + (Examen Final × 20%)' },
  exportGradebook: { en: 'Export Gradebook (CSV)', es: 'Exportar Calificaciones (CSV)' },
  confirmSaveGrades: { en: 'Do you want to save the updated evaluation grades?', es: '¿Deseas guardar las calificaciones y evaluaciones actualizadas?' },
  searchByStudentOrId: { en: 'Search by student name or ID...', es: 'Buscar por estudiante o matrícula...' },
  editModeActive: { en: 'Edit Mode Active', es: 'Modo Edición Activo' },
  weightedEvaluationSystem: { en: 'Weighted Evaluation System:', es: 'Sistema Ponderado de Evaluación:' },
  noEnrolledStudentsFound: { en: 'No enrolled students found', es: 'No se encontraron estudiantes inscritos' },
  tryAnotherSearchTerm: { en: 'Try another search term.', es: 'Prueba con otro término de búsqueda.' },
  ...
  enrollmentRoster: { en: 'Enrollment Roster', es: 'Lista de Inscripción' },
  noSyllabusDescription: { en: 'No syllabus description provided.', es: 'Sin descripción del programa.' },
  selectDateAttendanceSub: { en: 'Select a date to view or update attendance', es: 'Selecciona una fecha para ver o actualizar la asistencia' },
  courseRoster: { en: 'Course Roster', es: 'Lista de Estudiantes' },
  hideSidebar: { en: 'Hide Sidebar', es: 'Ocultar Barra Lateral' },
  showSidebar: { en: 'Show Sidebar', es: 'Mostrar Barra Lateral' },
  totalRecords: { en: 'Total Records', es: 'Total de Registros' },
  ...
  // Feature 6: Student Financial & Billing Portal
  navBilling: { en: 'Finances', es: 'Finanzas' },
  financialSummary: { en: 'Financial Summary', es: 'Resumen Financiero' },
  outstandingBalance: { en: 'Outstanding Balance', es: 'Saldo Pendiente' },
  totalPaid: { en: 'Total Paid', es: 'Total Pagado' },
  nextDueDate: { en: 'Next Due Date', es: 'Próximo Vencimiento' },
  financialSolvent: { en: 'Solvent / Up to Date', es: 'Solvente / Al Día' },
  financialPending: { en: 'Pending Payment', es: 'Pago Pendiente' },
  payNow: { en: 'Pay', es: 'Pagar' },
  payTuition: { en: 'Pay Tuition & Fees', es: 'Pagar Matrícula y Cuotas' },
  invoicesAndFees: { en: 'Invoices & Installments', es: 'Cuotas y Facturas' },
  invoicesSub: { en: 'Track term installments, due dates, and download payment receipts', es: 'Consulta tus cuotas del ciclo, vencimientos y descarga tus comprobantes' },
  concept: { en: 'Concept / Description', es: 'Concepto / Descripción' },
  dueDate: { en: 'Due Date', es: 'Fecha de Vencimiento' },
  amount: { en: 'Amount', es: 'Monto' },
  paidDate: { en: 'Payment Date', es: 'Fecha de Pago' },
  paid: { en: 'Paid', es: 'Pagado' },
  payInvoice: { en: 'Pay Invoice', es: 'Pagar Cuota' },
  viewReceipt: { en: 'Receipt', es: 'Recibo' },
  officialReceipt: { en: 'Official Payment Receipt', es: 'Comprobante Oficial de Pago' },
  receiptNumber: { en: 'Receipt No.', es: 'No. Comprobante' },
  paymentMethod: { en: 'Payment Method', es: 'Método de Pago' },
  creditDebitCard: { en: 'Credit / Debit Card', es: 'Tarjeta de Crédito / Débito' },
  bankTransfer: { en: 'Bank Transfer', es: 'Transferencia Bancaria' },
  cardNumber: { en: 'Card Number', es: 'Número de Tarjeta' },
  cardHolder: { en: 'Cardholder Name', es: 'Nombre en la Tarjeta' },
  expiryDate: { en: 'Exp Date', es: 'Vencimiento' },
  cvv: { en: 'CVV', es: 'CVV' },
  confirmPayment: { en: 'Confirm Payment', es: 'Confirmar y Pagar' },
  processingPayment: { en: 'Processing Payment...', es: 'Procesando Pago Seguro...' },
  paymentSuccess: { en: 'Payment processed successfully!', es: '¡Pago procesado exitosamente!' },
  paymentSuccessSub: { en: 'Your account balance and solvency status have been updated in real-time.', es: 'Tu estado de cuenta y solvencia han sido actualizados en tiempo real.' },
  approvedAndReconciled: { en: 'Approved & Reconciled', es: 'Aprobado & Conciliado' },
  tuitionFeeDescription: { en: 'Institutional academic tuition fee in DOP', es: 'Pago de aranceles académicos institucionales en DOP' },
  totalSettled: { en: 'Total Settled:', es: 'Total Liquidado:' },
  treasuryDigitalSeal: { en: 'Treasury Digital Seal', es: 'Sello Digital de Tesorería' },
  printReceipt: { en: 'Print / Save Receipt', es: 'Imprimir / Guardar Recibo' },
  financialOffice: { en: 'Bursar & Treasury Office', es: 'Departamento de Tesorería' },
  validAndSolvent: { en: 'VALID & SOLVENT', es: 'VÁLIDO & SOLVENTE' },
  tuitionInstallment1: { en: 'Tuition Installment 1 (Enrollment)', es: 'Cuota de Matrícula 1 (Inscripción)' },
  tuitionInstallment2: { en: 'Tuition Installment 2 (Midterm)', es: 'Cuota de Matrícula 2 (Medio Término)' },
  tuitionInstallment3: { en: 'Tuition Installment 3 (Final Period)', es: 'Cuota de Matrícula 3 (Cierre de Ciclo)' },
  labFee: { en: 'Computing Lab & Technology Fee', es: 'Cuota de Laboratorios & Tecnología' },
  studentCardFee: { en: 'Digital ID & Student Services Fee', es: 'Servicios Estudiantiles & Carnet' },
  
  // Admin Finance & Billing Management
  adminFinancesTitle: { en: 'Finances', es: 'Finanzas' },
  adminFinancesSub: { en: 'Monitor institutional tuition collections, student payment solvencies, receipts, and invoices', es: 'Supervisa la recaudación de matrículas, solvencias estudiantiles, recibos y facturas' },
  totalCollected: { en: 'Total Collected', es: 'Total Recaudado' },
  totalPendingReceivable: { en: 'Pending Receivable', es: 'Total por Cobrar' },
  collectionRate: { en: 'Collection Rate', es: 'Tasa de Cobro' },
  solventStudents: { en: 'Solvent Students', es: 'Estudiantes Solventes' },
  registerPayment: { en: 'Collect', es: 'Cobrar' },
  collectFee: { en: 'Collect Fee', es: 'Cobrar en Ventanilla' },
  lastFourDigits: { en: 'Last 4 Digits', es: 'Últimos 4 Dígitos' },
  allStatuses: { en: 'All Statuses', es: 'Todos los Estados' },
  allConcepts: { en: 'All Concepts', es: 'Todos los Conceptos' },
  exportFinanceReport: { en: 'Export Report', es: 'Exportar Reporte' },
  studentCodeOrName: { en: 'Search student, code, or receipt...', es: 'Buscar por estudiante, matrícula o recibo...' },
  paymentRegisteredSuccess: { en: 'Payment successfully registered and receipt generated.', es: 'Pago registrado con éxito y comprobante generado.' },
  cashierDesk: { en: 'Cash / Window', es: 'Efectivo / Ventanilla' },
  folioNumber: { en: 'Receipt / Folio', es: 'No. Recibo / Folio' },
  notesAndAuthOptional: { en: 'Notes / Bank Authorization No. (Optional)', es: 'Observaciones / No. Autorización Banco (Opcional)' },
  notesAndAuthPlaceholder: { en: 'e.g., POS Auth #49120, Transfer Ref #...', es: 'Ej: Autorización POS #49120, Ref. Transf #...' },
  cashVentanilla: { en: 'Cash at Cashier / Window', es: 'Efectivo en Ventanilla / Caja' },
  posCardVentanilla: { en: 'POS Card (Window)', es: 'Tarjeta POS (Ventanilla)' },
  wireBhd: { en: 'BHD Bank Transfer', es: 'Transferencia Banco BHD' },
  wireBanreservas: { en: 'Banreservas Bank Transfer', es: 'Transferencia Banreservas' },
  institutionalCheck: { en: 'Institutional Check', es: 'Cheque Institucional' },
  bankTransferDetailsTitle: { en: 'Dominican Pesos (DOP) Wire Transfer Details', es: 'Datos de Transferencia en Pesos Dominicanos (DOP)' },
  bankName: { en: 'Bank', es: 'Banco' },
  checkingAccountDop: { en: 'Checking Account DOP', es: 'Cuenta Corriente DOP' },
  accountHolder: { en: 'Account Holder', es: 'Titular' },
  
  officialReportCard: { en: 'Official Academic Transcript', es: 'Boletín Oficial de Calificaciones' },
  officialTranscript: { en: 'Official Transcript', es: 'Boletín Oficial' },
  ...
  cumulativeGPA: { en: 'Cumulative GPA', es: 'GPA Acumulado' },
  ...
  // Feature 3: Student 360 & Student Portal Details
  activeCourses: { en: 'Active Courses', es: 'Materias Activas' },
  scheduleAndRoom: { en: 'Schedule & Room', es: 'Horario & Aula' },
  average: { en: 'Average', es: 'Promedio' },
  approved: { en: 'Approved', es: 'Aprobado' },
  studentPersonalData: { en: 'Student Personal Data', es: 'Datos del Estudiante' },
  residentialAddress: { en: 'Residential Address', es: 'Dirección Residencial' },
  accountStatus: { en: 'Account Status', es: 'Estado de Cuenta' },
  accountSolvent: { en: 'Up to Date / Solvent', es: 'Al Día / Solvente' },
  overallPunctuality: { en: 'Overall Term Punctuality', es: 'Puntualidad Global del Ciclo' },
  excellent: { en: 'Excellent', es: 'Excelente' },
  attendancePolicy: { en: '* Minimum institutional attendance required for final exam eligibility is 80%.', es: '* El mínimo institucional para derecho a examen final es del 80% de asistencia.' },
  weight: { en: 'Weight', es: 'Ponderación' },
  graded: { en: 'Graded', es: 'Calificado' },
  pending: { en: 'Pending', es: 'Pendiente' },
  officialStudentCredential: { en: 'Official Student Credential', es: 'Credencial Oficial Estudiantil' },
  digitalSeal: { en: 'Digital Seal', es: 'Sello Digital' },
  softwareEngineering: { en: 'Software Engineering / Computer Science', es: 'Ingeniería de Software / Computer Science' },
  condition: { en: 'Condition', es: 'Condición' },
  bloodTypeO: { en: 'O Positive (O+)', es: 'O Positivo (O+)' },
  grades: { en: 'Grades', es: 'Calificaciones' },
  students: { en: 'Students', es: 'Estudiantes' },

  // Feature 4: Attendance Tracker Details
  realTime: { en: 'Real-time', es: 'En Tiempo Real' },
  attendanceTrackerSub: { en: 'Rapid attendance roll call and daily logging per subject', es: 'Toma de lista rápida y registro de asistencia diaria por asignatura' },
  classDate: { en: 'Class Date', es: 'Fecha de Clase' },
  selectDate: { en: 'Select date', es: 'Seleccionar fecha' },
  loadingStudents: { en: 'Loading student list...', es: 'Cargando lista de estudiantes...' },
  noStudentsEnrolled: { en: 'No students enrolled in this subject.', es: 'No hay estudiantes inscritos en esta asignatura.' },
  attendanceStatus: { en: 'Attendance Status', es: 'Estado de Asistencia' },
  notesObservation: { en: 'Notes / Observations', es: 'Observaciones / Nota' },
  addNotePlaceholder: { en: 'Add note or observation...', es: 'Agregar nota u observación...' },

  // Feature 5: Notifications & Live Activity Center
